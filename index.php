...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="https://source.unsplash.com/2400x700/?coding,laptop" class="d-block w-100" alt="...">
    </div>
  </div>
        ...
        while($row = mysqli_fetch_assoc($result)){
           ...
           echo '<div class="col-md-4 my-2">
                <div class="card" style="width: 18rem;">
                    ...
                    <!-- <img src="./img/pic'.$id.'.jpg" class="card-img-top" alt="error"> -->

                  <img src="https://source.unsplash.com/400x400/?' . $cat . 'coding,html" alt="" class="card-img-top">
                    <div class="card-body">
